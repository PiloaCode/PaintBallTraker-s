...
<section class="row">
  ...
  <p class="intro">
    ...
    recherche un lieux ou vous pouvez pratiquer le paintball. Vous pouvez oar exemple cherchez le lieux le plus
    proche, pour cela il vous suffit de vous rendre sur la page Recherche. 
  </p>
